...
class SubscriptionContextManager:
    ...
    lifetime: int
    def __init__(self, app: Application, address: Address, monitored_object_identifier: ObjectIdentifier, subscriber_process_identifier: int, issue_confirmed_notifications: bool, lifetime: int) -> None:
        ...
...
class Subscription(DebugContents):
    ...
    def __init__(self, obj_ref, client_addr, proc_id, obj_id, confirmed, lifetime, cov_inc) -> None:
        ...
...
class ChangeOfValueServices:
    ...
    def change_of_value(self, address: Address, monitored_object_identifier: ObjectIdentifier, subscriber_process_identifier: Optional[int] = ..., issue_confirmed_notifications: Optional[bool] = ..., lifetime: Optional[int] = ...) -> SubscriptionContextManager:
        """
