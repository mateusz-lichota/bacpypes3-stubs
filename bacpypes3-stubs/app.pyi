...
import asyncio
import dataclasses
from typing import Any as _Any, Callable, Dict, List, Optional, TYPE_CHECKING, Tuple, Union
from .apdu import APDU, IAmRequest
from .appservice import ApplicationServiceAccessPoint
from .basetypes import ObjectPropertyReference, PropertyReference, Segmentation, ServicesSupported
from .comm import ApplicationServiceElement
from .debugging import DebugContents, bacpypes_debugging
from .netservice import NetworkServiceAccessPoint, NetworkServiceElement, RouterInfoCache
...
from .service.object import ReadRangeServices, ReadWritePropertyMultipleServices, ReadWritePropertyServices
...
@bacpypes_debugging
class Application(ApplicationServiceElement, WhoIsIAmServices, WhoHasIHaveServices, ReadWritePropertyServices, ReadWritePropertyMultipleServices, ReadRangeServices, ChangeOfValueServices):
    _debug: Callable[..., None]
    ...
    def __init__(self, *args, device_info_cache: Optional[DeviceInfoCache] = ..., **kwargs) -> None:
        ...
    
    @classmethod
    def from_object_list(cls, objects: List[Object], device_info_cache: Optional[DeviceInfoCache] = ..., router_info_cache: Optional[RouterInfoCache] = ..., aseID=...) -> Application:
        """
    ...
    @classmethod
    def from_json(cls, objects: List[Dict[str, _Any]], device_info_cache: Optional[DeviceInfoCache] = ..., router_info_cache: Optional[RouterInfoCache] = ..., aseID=...) -> Application:
        """
    ...
    @classmethod
    def from_args(cls, args: argparse.Namespace, device_info_cache: Optional[DeviceInfoCache] = ..., router_info_cache: Optional[RouterInfoCache] = ..., aseID=...) -> Application:
        ...
    ...
    async def get_vendor_info(self, *, device_instance: Optional[int] = ..., device_address: Optional[Address] = ..., vendor_identifier: Optional[int] = ...) -> VendorInfo:
        ...
    
    async def parse_object_identifier(self, arg: Union[int, str, tuple], *, device_instance: Optional[int] = ..., device_address: Optional[Address] = ..., vendor_identifier: Optional[int] = ..., vendor_info: Optional[VendorInfo] = ...) -> ObjectIdentifier:
        ...
    
    async def parse_property_reference(self, arg: Union[int, str, tuple], *, device_instance: Optional[int] = ..., device_address: Optional[Address] = ..., vendor_identifier: Optional[int] = ..., vendor_info: Optional[VendorInfo] = ...) -> PropertyReference:
        ...
    
    async def parse_object_property_reference(self, object_identifier: Union[int, str, tuple], property_reference: Union[int, str], *, device_instance: Optional[int] = ..., device_address: Optional[Address] = ..., vendor_identifier: Optional[int] = ..., vendor_info: Optional[VendorInfo] = ...) -> ObjectPropertyReference:
        ...
