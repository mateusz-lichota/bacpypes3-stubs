...
from ..primitivedata import Atomic, BitString, Boolean, CharacterString, Double, Integer, Real, Unsigned
from ..basetypes import DateTime, DeviceObjectPropertyReference, EventState, EventTransitionBits, EventType, LimitEnable, NotificationParameters, OptionalCharacterString, Reliability, SequenceOfEventParameterExtendedParameters, StatusFlags, TimerState, TimerTransition
...
class EventAlgorithm(Algorithm, DebugContents):
    ...
    def state_transition(self, new_state: Optional[EventState], immediate: bool = ...) -> None:
        """
    ...
    async def send_notifications(self, notification_parameters: Dict[str, _Any]) -> None:
        ...
