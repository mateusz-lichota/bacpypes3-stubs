...
class TagNumber(IntEnum):
    ...
    unsigned = ...
    integer = ...
    real = ...  # pyright: ignore[reportIncompatibleMethodOverride]
    double = ...
    octetString = ...
    characterString = ...
    bitString = ...
...
class TagList(Iterable[Tag]):
    ...
    tagList: _List[Tag]
    def __init__(
        self, arg: Union[_List[Tag], TagList, PDUData, None] = ...
    ) -> None: ...
...
class ElementInterface:
    ...
    async def read_property(
        cls, getter: Optional[Callable[[], _Any]], index: Optional[int] = ...
    ) -> _Any: ...
    @classmethod
...
class OctetString(Atomic, bytes):
    ...
    @classmethod
    def decode(cls, tag_list: TagList) -> OctetString:  # pyright: ignore[reportIncompatibleMethodOverride]
        """
...
class CharacterString(Atomic, str):
    ...
    def encode(self) -> TagList:  # pyright: ignore[reportIncompatibleMethodOverride]
        """
...
class BitString(Atomic, list[Literal[0, 1]], metaclass=BitStringMetaclass):
    ...
    @classmethod
    def cast(cls: type, arg: _Any) -> _Any: ...
    def __getitem__(self, item: int | str) -> int: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    def __setitem__(self, item: int | str, value: int) -> None: ...  # pyright: ignore[reportIncompatibleMethodOverride]
...
class ObjectType(Enumerated):
    _vendor_range: tuple[int, int] = ...
    _high_limit: int | None = ...
    accessCredential = ...
    accessDoor = ...
    accessPoint = ...
    accessRights = ...
