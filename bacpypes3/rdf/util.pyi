...
@bacpypes_debugging
def sequence_to_graph(seq: Sequence, node: URIRef, graph: Optional[Graph] = ...) -> Graph:
...
@bacpypes_debugging
def extendedlist_to_graph(xlist: ExtendedList, subject: URIRef, predicate: URIRef, graph: Optional[Graph] = ...) -> Graph:
    """Encode an extended list as a graph."""
    ...

@bacpypes_debugging
def graph_to_extendedlist(graph: Graph, subject: URIRef, predicate: URIRef, xlist_class: type) -> ExtendedList:
