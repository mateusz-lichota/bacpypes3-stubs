...
from typing import Any as _Any, Callable, Optional, Tuple, Union
from ..apdu import ReadPropertyMultipleRequest, ReadPropertyRequest, ReadRangeRequest, WritePropertyRequest
from ..basetypes import PropertyIdentifier, PropertyReference
from ..constructeddata import List
...
class ReadWritePropertyServices:
    ...
    async def read_property(self, address: Union[Address, str], objid: Union[ObjectIdentifier, str], prop: Union[PropertyIdentifier, str], array_index: Optional[int] = ...) -> _Any:
        """
    ...
    async def write_property(self, address: Union[Address, str], objid: Union[ObjectIdentifier, str], prop: Union[PropertyIdentifier, str], value: _Any, array_index: Optional[int] = ..., priority: Optional[int] = ...) -> _Any:
        """
...
@bacpypes_debugging
async def read_property_to_any(obj, propertyIdentifier, propertyArrayIndex=...): # -> ElementMetaclass | Element:
    """Read the specified property of the object, with the optional array index,
    and cast the result into an Any object."""
    ...

@bacpypes_debugging
async def read_property_to_result_element(obj, propertyIdentifier, propertyArrayIndex=...): # -> Sequence:
    """Read the specified property of the object, with the optional array index,
    and cast the result into an Any object."""
    ...
...
class ReadWritePropertyMultipleServices:
    ...
    device_object: Optional[DeviceObject]
    device_info_cache: DeviceInfoCache
    async def read_property_multiple(self, address: Address, parameter_list: List[Tuple[Union[ObjectIdentifier, str], List[Union[PropertyReference, PropertyIdentifier, str]],],], vendor_info: Optional[VendorInfo] = ...) -> List[Tuple[ObjectIdentifier, PropertyIdentifier, Union[int, None], _Any]]:
        ...
...
class ReadRangeServices:
    ...
    device_object: Optional[DeviceObject]
    device_info_cache: DeviceInfoCache
    async def read_range(self, address: Address, objid: ObjectIdentifier, prop: PropertyIdentifier, arr_index: Optional[int] = ..., range_params: tuple = ...) -> _Any:
        """
