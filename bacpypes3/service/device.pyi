...
from ..apdu import DeviceCommunicationControlRequest, IAmRequest, IHaveRequest, WhoHasRequest
...
class WhoIsFuture:
    ...
    only_one: bool
    def __init__(self, app: WhoIsIAmServices, address: Optional[Address], low_limit: Optional[int], high_limit: Optional[int], timeout: Optional[int]) -> None:
        ...
...
class WhoIsIAmServices:
    ...
    def who_is(self, low_limit: Optional[int] = ..., high_limit: Optional[int] = ..., address: Optional[Address] = ..., timeout: Optional[int] = ...) -> asyncio.Future:
        ...
...
class WhoHasFuture:
    ...
    only_one: bool
    def __init__(self, app: WhoHasIHaveServices, low_limit: Optional[int], high_limit: Optional[int], object_identifier: Optional[ObjectIdentifier], object_name: Optional[CharacterString], timeout: Optional[int]) -> None:
        ...
...
class WhoHasIHaveServices:
    ...
    def who_has(self, low_limit: Optional[int] = ..., high_limit: Optional[int] = ..., object_identifier: Optional[ObjectIdentifier] = ..., object_name: Optional[CharacterString] = ..., address=..., timeout: Optional[int] = ...): # -> Future[Any]:
        ...
    ...
    def i_have(self, object_identifier: ObjectIdentifier, object_name: CharacterString, address=...) -> None:
        ...
...
class DeviceCommunicationControlServices:
    ...
    async def do_DeviceCommunicationControlRequest(self, apdu: DeviceCommunicationControlRequest) -> None:
        ...
    
    def enable_communications(self): # -> None:
        ...
    
    def disable_communications(self, enable_disable): # -> None:
        ...
