...
class IPv4DatagramServer(Server[PDU]):
    ...
    async def retrying_create_datagram_endpoint(self, loop: asyncio.events.AbstractEventLoop, addrTuple: Tuple[str, int]): # -> tuple[DatagramTransport, IPv4DatagramProtocol]:
        """
