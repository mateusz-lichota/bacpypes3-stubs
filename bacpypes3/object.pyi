...
from .primitivedata import BitString, Boolean, CharacterString, Date, Double, Integer, ObjectIdentifier, ObjectType, OctetString, Real, Time, Unsigned, Unsigned16, Unsigned8
from .constructeddata import AnyAtomic, ArrayOf, ListOf, Sequence, SequenceMetaclass
from .basetypes import AccessCredentialDisable, AccessCredentialDisableReason, AccessEvent, AccessPassbackMode, AccessRule, AccessThreatLevel, AccessUserType, AccessZoneOccupancyState, AccumulatorRecord, Action, ActionList, AddressBinding, AssignedAccessRights, AssignedLandingCalls, AuditLevel, AuditLogRecord, AuditOperationFlags, AuthenticationFactor, AuthenticationFactorFormat, AuthenticationPolicy, AuthenticationStatus, AuthorizationException, AuthorizationMode, BDTEntry, BackupState, BinaryLightingPV, BinaryPV, COVMultipleSubscription, COVSubscription, CalendarEntry, ChannelValue, ClientCOV, CredentialAuthenticationFactor, DailySchedule, DateRange, DateTime, Destination, DeviceObjectPropertyReference, DeviceObjectReference, DeviceStatus, DoorAlarmState, DoorSecuredStatus, DoorStatus, DoorValue, EngineeringUnits, EscalatorFault, EscalatorMode, EscalatorOperationDirection, EventLogRecord, EventNotificationSubscription, EventParameter, EventState, EventTransitionBits, EventType, FDTEntry, FaultParameter, FaultType, FileAccessMethod, HostNPort, IPMode, IPv4OctetString, IPv6OctetString, LandingCallStatus, LandingDoorStatus, LifeSafetyMode, LifeSafetyOperation, LifeSafetyState, LiftCarCallList, LiftCarDirection, LiftCarDoorCommand, LiftCarDriveStatus, LiftCarMode, LiftFault, LiftGroupMode, LightingCommand, LightingInProgress, LightingTransition, LimitEnable, LockStatus, LogMultipleRecord, LogRecord, LoggingType, MACAddress, Maintenance, NameValue, NameValueCollection, NetworkNumberQuality, NetworkPortCommand, NetworkSecurityPolicy, NetworkType, NodeType, NotifyType, ObjectPropertyReference, ObjectSelector, ObjectTypesSupported, OptionalBinaryPV, OptionalCharacterString, OptionalPriorityFilter, OptionalReal, OptionalUnsigned, Polarity, PortPermission, Prescale, PriorityFilter, PriorityValue, ProcessIdSelection, ProgramError, ProgramRequest, ProgramState, PropertyAccessResult, PropertyIdentifier, ProtocolLevel, ReadAccessResult, ReadAccessSpecification, Recipient, Relationship, Reliability, RestartReason, RouterEntry, Scale, SecurityKeySet, SecurityLevel, Segmentation, ServicesSupported, SessionKey, SetpointReference, ShedLevel, ShedState, SilencedState, SpecialEvent, StageLimitValue, StatusFlags, TimeStamp, TimerState, TimerStateChangeValue, TimerTransition, VMACEntry, VTClass, VTSession, ValueSource, WriteStatus
...
class ObjectMetaclass(SequenceMetaclass):
    ...
    def __new__(cls: _Any, clsname: str, superclasses: Tuple[type, ...], attributedict: Dict[str, _Any]) -> ObjectMetaclass:
        ...
...
class Object(Sequence, metaclass=ObjectMetaclass):
    ...
    def __init__(self, init_dict: Optional[Dict[str, _Any]] = ..., **kwargs: _Any) -> None:
        ...
    ...
    async def read_property(self, attr: Union[int, str], index: Optional[int] = ...) -> _Any:
        ...
